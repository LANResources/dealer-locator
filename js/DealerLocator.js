  ...
  var Dealer = Backbone.Model.extend(_.extend({
    initialize: function() {
      ...
      this.set({
        ...
        product_lines: _.intersect(['Backyard Boost®', 'DuraFerm®', 'Gain Smart®', 'Sure Champ®', 'VitaFerm®', 'Vitalize®'], this.get('dealer_types'))
      });
    },
...
////////////////////////////////////////
  var Dealers = Backbone.Collection.extend(_.extend({
      ...
      product_lines: ['Backyard Boost®', 'DuraFerm®', 'Gain Smart®', 'Sure Champ®', 'VitaFerm®', 'Vitalize®'],
      bounds: null,
      filter_cache: null,
